...
object AnimatorUtil {
    ...
    fun handleBottomNavScaleAnimator(viewTarget: Drawable, propertyName: String): ObjectAnimator {
        return ObjectAnimator.ofFloat(viewTarget, propertyName, 1f, 1.1f, 0.9f, 1f)
    }

    fun handleWithAnimatorSet(
        playAnimator: ObjectAnimator, afterAnimator: ObjectAnimator, duration: Long
    ) {
        val animSet = AnimatorSet()
        animSet.play(playAnimator).with(afterAnimator)
