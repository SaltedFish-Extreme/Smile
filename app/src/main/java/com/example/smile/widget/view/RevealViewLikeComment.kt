 ...
 * desc: 揭示视图(喜欢评论)
 */
class RevealViewLikeComment @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun getCheckedLayoutId() = R.layout.view_reveal_like_comment_checked

    override fun getUncheckedLayoutId() = R.layout.view_reveal_like_comment_unchecked
    ...
    fun setOnClickListener(onClickListener: OnClickListener) {
        ...
        clickNoRepeat {
            if (AppConfig.token.isNotEmpty()) {
                //登陆过直接走点击事件回调
                mOnClickListener.onClick(this@RevealViewLikeComment)
    ...
    interface OnClickListener {
        fun onClick(v: RevealViewLikeComment)
    }
}