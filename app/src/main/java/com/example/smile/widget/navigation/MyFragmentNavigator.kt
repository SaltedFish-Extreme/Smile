package com.example.smile.widget.navigation
...
class MyFragmentNavigator(
    private val mContext: Context, private val mFragmentManager: FragmentManager, private val mContainerId: Int
            ...
            isSingleTopReplacement -> {
                ...
                if (mBackStack.size > 1) {
                    ...
                    mFragmentManager.popBackStack(
                        generateBackStackName(mBackStack.size, mBackStack.peekLast()!!), FragmentManager.POP_BACK_STACK_INCLUSIVE
                    )
