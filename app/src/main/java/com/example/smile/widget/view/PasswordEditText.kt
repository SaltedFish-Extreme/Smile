...
class PasswordEditText @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = android.R.attr.editTextStyle) :
    ...
    private val visibleDrawable: Drawable = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_password_hide)!!)
    ...
    init {
        ...
        invisibleDrawable = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_password_show)!!)
