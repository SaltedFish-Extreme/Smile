 ...
 * desc: 揭示视图(喜欢视频)
 */
class RevealViewLikeVideo @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun getCheckedLayoutId() = R.layout.view_reveal_like_video_checked

    override fun getUncheckedLayoutId() = R.layout.view_reveal_like_video_unchecked
    ...
    fun setOnClickListener(onClickListener: OnClickListener) {
        ...
        setOnClickListener {
            if (AppConfig.token.isNotEmpty()) {
                //登陆过直接走点击事件回调
                mOnClickListener.onClick(this@RevealViewLikeVideo)
    ...
    interface OnClickListener {
        fun onClick(v: RevealViewLikeVideo)
    }
}