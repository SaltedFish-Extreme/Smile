 ...
 * desc: 揭示视图(喜欢)
 */
class RevealViewLike @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    fun setOnClickListener(onClickListener: OnClickListener) {
        ...
        setOnClickListener {
            if (AppConfig.token.isNotEmpty()) {
                //登陆过直接走点击事件回调
                mOnClickListener.onClick(this@RevealViewLike)
