...
/**
 * Created by 咸鱼至尊 on 2023/11/17
 *
 * desc: 揭示视图(收藏)
 */
class RevealViewCollect @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun getCheckedLayoutId() = R.layout.view_reveal_collect_checked

    override fun getUncheckedLayoutId() = R.layout.view_reveal_collect_unchecked
    ...
    fun setOnClickListener(onClickListener: OnClickListener) {
        ...
        clickNoRepeat {
            if (AppConfig.token.isNotEmpty()) {
                //登陆过直接走点击事件回调
                mOnClickListener.onClick(this@RevealViewCollect)
    ...
    interface OnClickListener {
        fun onClick(v: RevealViewCollect)
    }
}