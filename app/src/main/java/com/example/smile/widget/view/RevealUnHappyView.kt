 ...
 * desc: 揭示视图(不开心)
 */
class RevealUnHappyView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun getCheckedLayoutId() = R.layout.view_reveal_unhappy_checked

    override fun getUncheckedLayoutId() = R.layout.view_reveal_unhappy_unchecked
    ...
    fun setOnClickListener(onClickListener: OnClickListener) {
        ...
        setOnClickListener {
            if (AppConfig.token.isNotEmpty()) {
                //登陆过直接走点击事件回调
                mOnClickListener.onClick(this@RevealUnHappyView)
    ...
    interface OnClickListener {
        fun onClick(v: RevealUnHappyView)
    }
}